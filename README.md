# Population-Sim
PopulationSim is an open platform for gnerating synthetic oerson and households. It emerged from Oregon DOT’s desire to build a shared, open, platform that could be easily adapted for statewide, regional, and urban transportation planning needs.
# What is population synthesis?
Activity based travel demand models such as ActivitySim operate at an individual level, wherein the travel choices of person and household decision-making agents are predicted by applying Monte Carlo methods to behavioral models. This requires a data set of households and persons representing the entire population in the modeling region. Population synthesis refers to the process used to create this data.
